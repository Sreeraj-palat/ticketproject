...
<ul>
  ...
  <li><input type="email" placeholder="your email address"
       ...
       <div class="register"><a href="https://sreerajpalat.zendesk.com/auth/v2/login/registration" target="_blank">Register</a> so our support team can email you to solve your problem.</div>
       </li>
  % end
